...
const CHANNEL_TYPE_CONSULT_CENTER	    = "13";
...
// 2018.06.25
const PACKET_LENGTH_AGT_CONSULT_SHL     = "1366";
const PACKET_LENGTH_AGT_CONSULT_ENC     = "1366";
...
// 2018.06.25
const PK_LEN_AGT_CONSULT_SHL            = 1366;
const PK_LEN_AGT_CONSULT_ENC            = 1366;
...
// 2018.06.25
const PK_LEN_INBOUND_DATA_SHL           = 1085;
const PK_LEN_CONSULT_DATA_SHL           = 100;
...
// 2018.07.23 New 
//------------------------------------------------------------------------------
//  The position of Agent common packet     
//------------------------------------------------------------------------------
const POS_PK_AGT_PACKET_KEY         = 0;
const POS_PK_AGT_LENGTH             = POS_PK_AGT_PACKET_KEY     + PK_LEN_PACKET_KEY;                    // 8 = 0+8
const POS_PK_AGT_RESULT_CODE        = POS_PK_AGT_LENGTH         + PK_LEN_LENGTH;                        // 12 = 8+4
const POS_PK_AGT_SVC_KEY            = POS_PK_AGT_RESULT_CODE    + PK_LEN_RESULT_CODE;                   // 17 = 12+5
const POS_PK_AGT_SVC_CODE           = POS_PK_AGT_SVC_KEY        + PK_LEN_SVC_KEY;                       // 25 = 17+8
const POS_PK_AGT_TIME               = POS_PK_AGT_SVC_CODE       + PK_LEN_SVC_CODE       + PK_LEN_FLAG;  // 29 = 25 + 3 + 'm'
const POS_PK_AGT_STATION            = POS_PK_AGT_TIME           + PK_LEN_TIME           + PK_LEN_FLAG;  // 44 = 29 + 14 + 's'
const POS_PK_AGT_AGENTID            = POS_PK_AGT_STATION        + PK_LEN_STATION        + PK_LEN_FLAG;  // 55 = 44 + 10 + 'a'
const POS_PK_AGT_EXTRA              = POS_PK_AGT_AGENTID        + PK_LEN_AGENTID        + PK_LEN_FLAG;  // 66 = 55 + 10 + 'e'
const POS_PK_AGT_STATUS             = POS_PK_AGT_EXTRA          + PK_LEN_EXTRA          + PK_LEN_FLAG;  // 77 = 66 + 10 + 'u' 2018.10.10 ���� ����
const POS_PK_AGT_RES_COMMON         = POS_PK_AGT_STATUS         + PK_LEN_STATUS;     // + PK_LEN_FLAG;  // 79 = 77 + 2        2018.10.12 ���� ����(Remove PK_LEN_FLAG)
...
// 2018.10.10 Query UCID
const SVC_CODE_QRY_UCID					= 306;
const SVC_KEY_QRY_UCID					= "A_QRYUCI";
...
// 2018.06.20 Consultation SHL
const SVC_CODE_CALL_CONSULT_SHL		    = 220; 
const SVC_KEY_CALL_CONSULT_SHL		    = "A_CONSHL";

// 2018.07.03 Consultation ENC
const SVC_CODE_CALL_CONSULT_ENC		    = 221; 
const SVC_KEY_CALL_CONSULT_ENC		    = "A_CONENC";
...
function get_common_packet(p_svc_key, p_svc_code, station, agentid, extra, reason_code, reserved)
{
    ...
    disp_log("CommonPacket=["+ common_packet + "]" + common_packet.length);                   
...
//  get_consult_packet
//==============================================================================
function get_consult_shl_packet(p_svc_key, p_svc_code, station, agentid, consult_dest, consult_ani, consult_ucid, inbound_data, consult_data)
{
    var p_result_code   = get_packet_field("",          PK_LEN_RESULT_CODE);
    var p_time          = get_packet_time();
    var p_station       = get_packet_field(station,     PK_LEN_STATION);
    ...
    var p_ani           = get_packet_field(consult_ani, PK_LEN_ANI);
    var p_ucid          = get_packet_field(consult_ucid,PK_LEN_UCID);
    var p_inbound_data  = get_packet_field(inbound_data,PK_LEN_INBOUND_DATA_SHL);
    var p_consult_data  = get_packet_field(consult_data,PK_LEN_CONSULT_DATA_SHL);
    
    var consult_packet  = PACKET_KEY_AGT_SERVICE +
                          PACKET_LENGTH_AGT_CONSULT_SHL + 
                          p_result_code +
                          p_svc_key +
                          p_svc_code +
                          "m" + p_time +
...
//  get_consult_packet
//==============================================================================
function get_consult_enc_packet(p_svc_key, p_svc_code, station, agentid, consult_dest, consult_ani, consult_ucid, enc_data)
{
    var p_result_code   = get_packet_field("",          PK_LEN_RESULT_CODE);
    var p_time          = get_packet_time();
    var p_station       = get_packet_field(station,     PK_LEN_STATION);
