...
//    document.getElementById("p_inbound_data").value = json_evt.WSK_EVENT.inbound_data;
//    document.getElementById("p_consult_data").value = json_evt.WSK_EVENT.consult_data;
//    // Popup
//    $('#mdl-popup').modal();
//    $('#btn_answer').focus();
...
//----------------------------------------------------------------------
//  (Password)Customer Cleared Event
//----------------------------------------------------------------------
function on_event_customer_cleared(json_evt)
{
    var callid  = json_evt.WSK_EVENT.callid;
    wse_callid2_    = 0;

    disp_log("<CustomerCleared> CID=" + wse_callid1_+ ", 2nd_CID=" + callid);
}
...
function on_event_drop_socket(json_evt) {
    disp_log("<Connection dropped!> Drop by IP=" + json_evt.WSK_EVENT.res_basic);
    g_dropped_ = true;
