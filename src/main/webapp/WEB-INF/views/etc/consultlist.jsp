...
<script>
	...
	function consultation() {
		...
		opener.cmd_ctConsultation(c_number);
		$("#consultation").hide();
		$("#reconnect").show();
		$("#transfer").show();
	...
	function BlindTransfer(division) {/* 호전환 -외부전문기관,ARS */
		...
		opener.cmd_ctBlindTransfer(b_number);
		window.close();
	}
	function reconnect() {/* 호전환 - 복귀 */
		opener.cmd_ctReconnect();
		$("#consultation").show();
		$("#reconnect").hide();
		$("#transfer").hide();
	}
		...
		<div style="width:664px;height:394px;">
				...
				<div class="call-transfer">
						<div class="call-transfer_in" style="float:left;" >
							...
							<p style="margin-top:10px;">
								<form action="c_check" name="c_frm" method="post" onSubmit="return c_check()">
			...
			<div class="hide2">
				...
				<div class="call-transfer_in" style="float:left;" >
					...
					<p style="margin-top:10px;">
						<form action="c_check2" name="c_frm" method="post" onSubmit="return c_check2()">
